...
func main() {
	...
	flag.StringVar(&metricsIP, "metrics.ip", "0.0.0.0:9000", "IP and Port for the metrics exporter")
	flag.StringVar(&metricsPath, "metrics.path", "/metrics", "path under metrics are exposed")
